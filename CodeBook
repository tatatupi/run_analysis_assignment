...
The variables manipulated in the script are:

"subject": a number representing a participant               
"label": the activity label identifying the action of the participant

And the measurements of interest are:
...
The data used is available at http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones 
